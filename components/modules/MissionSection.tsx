    ...
    <div className="w-full max-w-5xl mx-auto px-4">
      ...
      >
        ...
        <p className="text-mist/60 max-w-2xl mx-auto">
          More than a bank. A movement for a greener future.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        >
          ...
          <h3 className="text-xl font-bold text-mist mb-4">Our Mission</h3>
        ...
        >
          ...
          <h3 className="text-xl font-bold text-mist mb-4">Our Vision</h3>
      ...
      >
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6">
          ...
          <span className="text-sm font-medium text-mist/70">Core Values</span>
        </div>
