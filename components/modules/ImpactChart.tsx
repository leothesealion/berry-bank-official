...
export function ImpactChart({ 
  ...
  // Use CMS data if available, then props, then defaults
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
          ...
          <ResponsiveContainer width="100%" height="100%" minHeight={250}>
            ...
            >
              <XAxis 
                type="number" 
                domain={[0, 60]}
                tick={{ fill: '#FAFAFA', fontSize: 12, opacity: 0.6 }}
                axisLine={{ stroke: '#FAFAFA', strokeOpacity: 0.2 }}
              ...
              <Tooltip
                ...
                formatter={(value) => [`${value}% reduction`, 'Carbon Footprint']}
      ...
      >
        <p className="text-lg text-growth font-semibold">
          52.2% less carbon footprint
        </p>
        <p className="text-sm text-mist/50 mt-1">
          Just by switching to a green bank
        </p>
      </motion.div>
    </div>
  );
